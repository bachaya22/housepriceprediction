...
def get_location_names():
    """
    API endpoint to get the list of location names.
    """
    response = jsonify({
        'locations': util.get_location_names()
    })
...
if __name__ == "__main__":
    ...
    util.load_saved_artifacted()  # Ensure artifacts are loaded before handling requests
    app.run(debug=True)
